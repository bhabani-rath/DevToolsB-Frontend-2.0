  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 px-6">
        <h2 className="text-2xl font-bold text-transparent bg-gradient-to-r from-violet-600 via-pink-600 to-purple-600 dark:from-violet-400 dark:via-pink-500 dark:to-purple-500 bg-clip-text">
          {sectionHeader}
        </h2>
      ...
      {/* Stats Section */}
      <div
        className="w-full flex justify-around items-center gap-4 px-6 py-4 
      ...
      >
        ...
        <div className="h-12 w-px bg-gray-300 dark:bg-slate-600"></div>
        <div className="flex flex-col justify-center items-center">
